...
CREATE TABLE `departments`  (
  ...
  `department_name` varchar(3) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
...
CREATE TABLE `employees`  (
  ...
  `first_name` varchar(20) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `last_name` varchar(25) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `email` varchar(25) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `phone_number` varchar(20) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `job_id` varchar(10) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
...
CREATE TABLE `job_grades`  (
  `grade_level` varchar(3) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
...
CREATE TABLE `jobs`  (
  ...
  `job_title` varchar(35) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
...
CREATE TABLE `locations`  (
  ...
  `street_address` varchar(40) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `postal_code` varchar(12) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `city` varchar(30) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `state_province` varchar(25) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
  `country_id` varchar(2) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci DEFAULT NULL,
