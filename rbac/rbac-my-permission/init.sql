...
CREATE TABLE `sys_acl` (
  ...
  `operate_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
...
CREATE TABLE `sys_log` (
  ...
  `operator` varchar(20) NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新的时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES ('1', 'Admin', '18612344321', 'admin@qq.com', 'E10ADC3949BA59ABBE56E057F20F883E', '1', '1', 'admin', 'system', '2017-10-13 08:46:16', '127.0.0.1'), ('2', 'Jimin', '13188889999', 'jimin@qq.com', 'E10ADC3949BA59ABBE56E057F20F883E', '1', '1', 'jimin.zheng', 'Admin', '2017-10-14 14:45:19', '127.0.0.1'), ('3', 'Jimmy', '13812344311', 'jimmy@qq.com', 'E10ADC3949BA59ABBE56E057F20F883E', '2', '1', '', 'Admin', '2017-10-16 12:57:35', '0:0:0:0:0:0:0:1'), ('4', 'Kate', '13144445555', 'kate@qq.com', 'E10ADC3949BA59ABBE56E057F20F883E', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1'), ('5', '服务员A', '18677778888', 'service@qq.com', 'E10ADC3949BA59ABBE56E057F20F883E', '12', '1', '', 'Admin', '2017-10-17 00:22:15', '0:0:0:0:0:0:0:1');
COMMIT;
